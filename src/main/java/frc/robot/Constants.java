...
public final class Constants {
  ...
  public static class SwerveDriveConstants {
    ...
    public static final double DRIVE_PEAK_CURRENT = 80; // Maximum current limit for the motor in amps, this number is
                                                        // in CTRE docs
    ...
    public static final double DRIVE_WHEEL_CIRCUMFERENCE = Units.inchesToMeters(4 * Math.PI); // Circumference of the
                                                                                              // drive wheel in Meters
  ...
  public static class SwerveSteerConstants {
    ...
    public static final double STEER_PEAK_CURRENT = 80; // Maximum current limit for the motor in amps, this number is
                                                        // in CTRE docs
  ...
  public static class SwerveConstants {
    ...
    public static final double MAX_VEL = 4800. / 6.923 / 60. * 2. * 2. * Math.PI * .0254; // Kraken speed / gear ratio /
                                                                                          // reduced to per second *
