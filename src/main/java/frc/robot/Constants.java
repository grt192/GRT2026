...
public final class Constants {
    ...
    public static final class ClimbConstants {
        ...
        public static final Distance WINCH_HOME_DISTANCE = Millimeters.of(0.148);
        public static final Distance WINCH_DEPLOYED_DISTANCE = Meters.of(0.047); // placeholder to tune
